...
if(isset($_POST['submit'])){
		...
		$betreff = 'PCP-on-Web Closing Meeting Registration'.$refer.' '.$_POST['name'];
		$nachricht = '';
...
<div class="row">
	...
	<form action="./?p=registration" method="post">
		...
		<div class="col-12"><h3>Registration</h3></div>
          ...
          <div class="control-group">
             <div class="form-group floating-label-form-group controls">
							<div class="col-2"><label>Conference Days</label></div>
							<div class="col-10">
									<input id="participation" type="checkbox" name="Conference_20" value="yes"/>Monday, March 20th<br/>
									<input id="participation" type="checkbox" name="Conference_21" value="yes"/>Tusday, March 21st<br/>
